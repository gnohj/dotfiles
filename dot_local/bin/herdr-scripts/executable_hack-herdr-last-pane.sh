...
# toggle). Focuses by pane id through herdr-focus-pane.sh (socket pane.focus): `agent focus`
# takes only panes hosting a live agent, so it silently failed on nvim/fish panes. Notifies
