...

{
  ...
  # exact same set from one flake.lock. mise owns the language runtimes plus the
  # fast-moving CLIs that need same-day releases; the nix-darwin Homebrew module
  # owns macOS-specific apps & services.
