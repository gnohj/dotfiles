...
generate_herdr_config() {
  ...
  . "$HOME/.config/colorscheme/relight.sh"
  ...
  [ -n "$herdr_sel_bg" ] || herdr_sel_bg="$(gnohj_relight "$gnohj_color04" 0.20)"
  ...
  local herdr_rows
  herdr_rows="$(printf 'rows = [["state_icon", "workspace"], [{ token = "$br", fg = "%s" }, { token = "$br_on", fg = "%s" }], [{ token = "$pr", fg = "%s", rules = [{ equals = "●", fg = "%s" }] }, { token = "$pr_d", fg = "%s" }, { token = "$ci", fg = "%s" }, { token = "$ci_d", fg = "%s" }, { token = "$sb", fg = "%s" }, { token = "$sb_d", fg = "%s" }, { token = "$jira", fg = "%s" }, { token = "$jira_d", fg = "%s" }]]' \
